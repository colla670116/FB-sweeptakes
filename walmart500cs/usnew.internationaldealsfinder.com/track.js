...
var campaignID = "678a2bac71994791216af5ee";
...
var initialSrc = "https://usnew.internationaldealsfinder.com/" + campaignID + "?format=json";
...
function fixHrefWithClick(
    ...
    document.querySelectorAll('a').forEach(function (el) {
        if (el.href.indexOf("usnew.internationaldealsfinder.com/click") > -1) {
    ...
    if (!urlParams.get('rtkcid')) {
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                xhrr.open("GET", "https://usnew.internationaldealsfinder.com/view?clickid=" + rawData.clickid)
                xhrr.send();
            }
        }
        ...
        xhrTrack.open("GET", "https://usnew.internationaldealsfinder.com/view?clickid=" + rtkClickID)
        xhrTrack.send();
