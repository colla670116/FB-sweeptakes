let questions = [
    ...
    '📍Q3: Do you want to receive ysl Gift Set?'
  ];
  let current = 0;
  ...
  // Fake Comments
  const comments = [
    { name: 'Susan T.', text: 'I just got mine in today!What a great gift ！ THANK YOU  🙌', img: 'https://randomuser.me/api/portraits/women/68.jpg' },
    { name: 'Greg P.', text: 'so crazy! thanks ysl!', img: 'https://randomuser.me/api/portraits/men/42.jpg' },
