...
var campaignID = "68e69282ebc4f14b838cf79c";
...
var initialSrc = "https://track.reviewprogramforproducts.com/" + campaignID + "?format=json";
...
function fixHrefWithClick(
    ...
    document.querySelectorAll('a').forEach(function (el) {
        if (el.href.indexOf("track.reviewprogramforproducts.com/click") > -1) {
    ...
    if (!urlParams.get('rtkcid')) {
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                xhrr.open("GET", "https://track.reviewprogramforproducts.com/view?clickid=" + rawData.clickid)
                xhrr.send();
            }
        }
        ...
        xhrTrack.open("GET", "https://track.reviewprogramforproducts.com/view?clickid=" + rtkClickID)
        xhrTrack.send();
